package com.aeropost.idempiere.restapi.order;
...
@Component(
		property = {
			HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_PATTERN + "=/idempiere/restapi/*",
		})
public class Config implements Servlet {
	...
	public Config() throws URISyntaxException, ClassNotFoundException{
		...
		String[] packages = {"com.aeropost.idempiere.restapi.order.impl"};
		logger.info("Started Configuration..." + getClass());
    ...
    void activate(ComponentContext context) {
    	logger.info("Activated Aeropost OMS Order REST API! " + getClass());
    }

    @Deactivate
	void deactivate(ComponentContext context) { logger.info("Deactivated Aeropost OMS Order REST API... " + getClass()); }
