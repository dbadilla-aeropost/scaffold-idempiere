package com.aeropost.oms.restapi.order;
...
@Component(
		property = {
			HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_PATTERN + "=/oms/restapi/*",
		})
public class Config implements Servlet {
	...
	public Config() throws URISyntaxException, ClassNotFoundException{
		...
		String[] packages = {"com.aeropost.oms.restapi.order.impl"};
